...
Each data set is added using the L<IUP::PPlotAdd |IUP::PPlotAdd >function. All other
...
=item * PPlotBegin()
 ...
 void IUP::PPlotBegin(Ihandle* ih, int strXdata); [in C]
...
=item * PPlotAdd()
 ...
 void IUP::PPlotAdd(Ihandle* ih, float x, float y); [in C]
 iup.PPlotAdd(ih: ihandle, x, y: number) [in Lua]

Adds a sample to the dataset. Can only be called if L<IUP::PPlotBegin|IUP::PPlotBegin>
was called with strXdata=0.

=item * PPlotAddStr()

 void IUP::PPlotAddStr(Ihandle* ih, const char* x, float y); [in C]
 iup.PPlotAddStr(ih: ihandle, x: string, y: number) [in Lua]

Same as L<IUP::PPlotAdd|IUP::PPlotAdd>, but allows to use a string as the X axis value.
Can only be called if L<IUP::PPlotBegin|IUP::PPlotBegin> was called with strXdata=1.

=item * PPlotEnd()

 int IUP::PPlotEnd(Ihandle* ih); [in C]
...
Can only be called if L<IUP::PPlotBegin|IUP::PPlotBegin> was called. Whenever you create
...
=item * PPlotInsert()
 ...
 void IUP::PPlotInsert(Ihandle *ih, int index, int sample_index, float x, float y); [in C]
 void IUP::PPlotInsertStr(Ihandle *ih, int index, int sample_index, const char* x, float y);
 iup.IUP::PPlotInsert(ih: ihandle, index, sample_index, x, y: number) [in Lua]
 iup.IUP::PPlotInsertStr(ih: ihandle, index, sample_index, x, y: number)

Inserts a sample in a dataset at the given B<sample_index>. Can be used
only after the dataset is added to the plot.

=item * PPlotInsertPoints()

 void IUP::PPlotInsertPoints(Ihandle *ih, int index, int sample_index, float* x, float* y, int count); [in C]
 void IUP::PPlotInsertStrPoints(Ihandle *ih, int index, int sample_index, const char** x, float* y, int count);
 iup.IUP::PPlotInsertPoints(ih: ihandle, index, sample_index, x, y: table of number) [in Lua]
 iup.IUP::PPlotInsertStrPoints(ih: ihandle, index, sample_index, x, y: table of number)
...
=item * PPlotAddPoints()
 ...
 void IUP::PPlotAddPoints(Ihandle *ih, int index, float* x, float* y, int count); [in C]
 void IUP::PPlotAddStrPoints(Ihandle *ih, int index, const char** x, float* y, int count);
 iup.IUP::PPlotAddPoints(ih: ihandle, index, x, y: table of number) [in Lua]
 iup.IUP::PPlotAddStrPoints(ih: ihandle, index, x, y: table of number)
...
=item * PPlotTransform()
 ...
 void IUP::PPlotTransform(Ihandle* ih, float x, float y, int *ix, int *iy); [in C]
...
=item * PPlotPaintTo()
 ...
 void IUP::PPlotPaintTo(Ihandle* ih, cdCanvas* cnv); [in C]
...
=item * x: X coordinate value of the sample
