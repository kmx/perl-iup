...
Character font of the text shown in the element. See L<FONT|XXX-FIXME>
...
Font - Encoding XXX-FIXME_replce_after_unicode support
...
B<See Also:> L<IUP::MapFont|IUP::MapFont>, L<IUP::UnMapFont|IUP::UnMapFont>
...
Name of the control inside the dialog. Not releated to L<SetName|IUP::Manual::02_Elements/"SetName()">.
