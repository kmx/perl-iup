...
so it can be associated with a native control. L<Show|IUP::Manual::02_Elements/"Show()">, B<
IUP::ShowXY> or L<Popup|IUP::Manual::02_Elements/"Popup()"> will automatically call L<Map|IUP::Manual::02_Elements/"Map()"> before
