...
tabs. Use L<SetName|IUP::Manual::02_Elements/"SetName()"> or XXX-FIX_ME to associate
a child to a name. In Lua (XXX-check-this-for-perl) you can also use the element reference
directly.
