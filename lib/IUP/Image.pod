...
Used only for images created with L<IUP::Image|IUP::Image>. XXX-color-depth
...
that points to names registered with L<SetName|IUP::Manual::02_Elements/"SetName()"> XXX-FIX_ME
attribute. 
...
You can obtain several images from the L<IUP::ImageLib::XXX|xxx.html>, a library of pre-defined images. To
view the images you can use the L<IUP::View|IUP::View> in the applications included
in the distribution, available at the L<Download|xxx.html>.
B<IUP::View> is also capable of converting several image formats into an 
L<IUP::Image>, and save IUP images as LED, Lua or ICO.
