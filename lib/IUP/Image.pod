...
(L<IUP::ImageRGB|IUP::ImageRGB> and L<IUP::ImageRGBA,|IUP::ImageRGBA,> since 3.0)

=head1 USAGE

=head2 CREATION - new() method

 Ihandle* IUP::Image(int width, int height, const unsigned char *pixels); [in C]
 Ihandle* IUP::ImageRGB(int width, int height, const unsigned char *pixels); [in C]
 Ihandle* IUP::ImageRGBA(int width, int height, const unsigned char *pixels); [in C]
