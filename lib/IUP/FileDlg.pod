...
=item "0": Normal, existing file or directory.
...
=item * L<0-basic/filedlg.pl|http://cpansearch.perl.org/src/KMX/IUP-0.001/examples/0-basic/filedlg.pl> - IUP::FileDlg example
...
The original doc: L<iupfiledlg.html|http://www.tecgraf.puc-rio.br/iup/en/elem/iupfiledlg.html>
