...
<p>
  <table border="1">
	...
	<tr>
		<td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.5/elem/iupsplit1.png"></td>
		<td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.5/elem/iupsplit2.png"></td>
	</tr>
    </tbody>
  </table>
</p>
...
=item * B<LAYOUTDRAG> (non inheritable)
...
=item * B<SHOWGRIP> (non inheritable)
...
Guide|xxx> for mode details on sizes.
