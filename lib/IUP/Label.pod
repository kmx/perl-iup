...
<p>
<img src="http://kmx.github.com/perl-iup/spec/iuplabel1.png"></td>
</p>
...
=item * B<ELLIPSIS> [Windows and GTK only]
...
size of the image in pixels. XXX-check-this Use L<SetName|IUP::Manual::02_Elements/"SetName()"> or
XXX-FIX_ME to
associate an image to a name. See also L<IUP::Image|IUP::Image>.
...
=item * B<SEPARATOR> (creation only, non inheritable)
...
=item * B<WORDWRAP> [Windows and GTK only]
