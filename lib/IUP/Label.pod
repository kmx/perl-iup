=for comment based on iup-3.5 (attributes refreshed to iup-3.32) - http://www.tecgraf.puc-rio.br/iup/en/elem/iuplabel.html
...
I<(non inheritable) [Windows and GTK Only]>
...
Action generated when the mouse is moved. (since iup-3.20)
