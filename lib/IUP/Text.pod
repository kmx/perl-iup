  ...
  <table border="1">
    ...
    <tbody align="center">
      <tr>
        ...
        <th style="text-align: center;">Windows<br>w/ Style</th>
      </tr>
      <tr>
...
$txt->SetAttribute( ADDFORMATTAG_HANDLE => IUP::User->new(
    ...
    SELECTION=>"2,1:2,12",
        ...
        <td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.5/elem/iuptext_formatting.png"></td>
      </tr>
    </tbody>
  </table>
</p>
...
See the Notes below if using UTF-8 strings in GTK. XXX-check-this
...
=item * L<FORMATTING|IUP::Manual::03_Attributes/FORMATTING> [Windows and GTK Only] (non inheritable)
...
=item * L<MASK|IUP::Manual::03_Attributes/MASK> (non inheritable)
...
=item * B<PASSWORD> [Windows and GTK Only] (creation only, non inheritable)
...
See the Notes below if using UTF-8 strings in GTK. XXX-chek-this

=item * B<SELECTIONPOS> (non inheritable)
...
=item * B<SPIN> (non inheritable, creation only)
