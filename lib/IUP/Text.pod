...
=head2 CREATION - new() method
 ...
 $text = IUP::Text->new(const char *action);
...
=item * L<FORMATTING|IUP::Manual::03_Attributes/FORMATTING> [Windows and GTK Only] (non
inheritable)
...
B<$self:> reference to the element (IUP::XXXIUP_Text) that activated the event
