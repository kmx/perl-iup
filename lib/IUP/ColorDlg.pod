...
<p>
  <table border="1">
	...
	<td style="text-align: left;"><img src="http://kmx.github.com/perl-iup/img-3.5/dlg/colordlg_win.png"></td>
      </tr>
      <tr>
        <th style="text-align: center;">ColorBrowser<br>based</th>
...
=item * L<0-basic/colordlg.pl|http://cpansearch.perl.org/src/KMX/IUP-0.001/examples/0-basic/colordlg.pl> - IUP::ColorDlg example (used for screenshot - IUP.pod)
...
The original doc: L<iupcolordlg.html|http://www.tecgraf.puc-rio.br/iup/en/elem/iupcolordlg.html>
