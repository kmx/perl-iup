...
=item * L<0-basic/colordlg.pl|http://cpansearch.perl.org/src/KMX/IUP-0.002_08/examples/0-basic/colordlg.pl> - IUP::ColorDlg example (used for screenshot - IUP.pod)
