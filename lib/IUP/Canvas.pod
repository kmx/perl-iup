...
=head3 cdSaveState()
 ...
 #NOTE: $state is a reference to IUP::Canvas::IUP::Canvas::InternalState object
...
=head3 cdRestoreState()
 ...
 $canvas->cdRestoreState($state);
 #NOTE: $state has to be a reference to IUP::Canvas::IUP::Canvas::InternalState object
...
=head3 cdGetImage()
 ...
 #NOTE: $image is a reference to IUP::Canvas::InternalServerImage object

Copies a rectangular region from the current rectangular context to the
memory - IUP::Canvas::InternalServerImage object (which can be later used
...
=head3 cdPutImage()
 ...
 #NOTE: $image has to be a reference to IUP::Canvas::InternalServerImage object
 $canvas->cdPutImage($image, $x, $y, $xmin, $xmax, $ymin, $ymax); 

=head3 wdPutImage

 #NOTE: $imegg has to be a reference to IUP::Canvas::InternalServerImage object
...
=head3 cdPlay()
 ...
 $status = $canvas->cdPlay($ctx, $xmin, $xmax, $ymin, $ymax, $data);
 #NOTE: $ctx has to be a reference to IUP::Canvas::InternalContext object
...
Returns the context (= reference to IUP::Canvas::InternalContext object) of a given canvas.

=head3 cdContextCaps()

 $context = $canvas->cdGetContext();
 #NOTE: $context param has to be a reference to IUP::Canvas::InternalContext
