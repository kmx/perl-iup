...
=item * L<0-basic/pplot_advanced.pl|http://cpansearch.perl.org/src/KMX/IUP-0.001/examples/0-basic/pplot_advanced.pl> - PPlot controls
...
=item * L<1-apps/app-pplot-demo.pl|http://cpansearch.perl.org/src/KMX/IUP-0.001/examples/1-apps/app-pplot-demo.pl> - dials for zooming
