...
=head1 DESCRIPTION and IUP::SpinBox
...
L<IUP::Spin|IUP::Spin>.
 ...
 $spinbox = IUP::Spinbox->new(Ihandle* child);
...
The original doc: L<iupspinbox.html|http://www.tecgraf.puc-rio.br/iup/en/elem/iupspinbox.html>
