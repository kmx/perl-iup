...
<p>
<img src="http://kmx.github.com/perl-iup/spec/iuptree1.png"></td>
</p>
...
IUP::Tree has three types of images: one associated to the leaf, one to
...
IUP::Tree allows marking several nodes simultaneously using the Shift and
...
=item * B<ADDEXPANDED> (non inheritable)
...
=item * B<DROPEQUALDRAG> (non inheritable)
...
=item * B<HIDEBUTTONS> (creation only)
...
=item * B<HIDELINES> (creation only)
...
=item * B<SHOWDRAGDROP> (creation only, non inheritable)
...
Image name to be used in the specified node, where id is
the specified node identifier. If id is empty, then the focus node is
used as the specified node. 
XXX-check-this Use L<IUP::SetHandle|IUP::SetHandle> 
XXX-check-this or L<IUP::SetAttributeHandle|IUP::SetAttributeHandle> to
XXX-check-this associate an image to a name. 
See also L<IUP::Image|IUP::Image>. 
...
<p>
  <table border="1">
    <tbody align="center">
      <tr>
        <th style="text-align: center;">Initial layout</th>
        <th style="text-align: center;">After calling: <pre>$tree->SetAttribute(ADDBRANCH9, "new branch");</pre></th>
      </tr>
      <tr>
...
<p>
  <table border="1">
    <tbody align="center">
      <tr>
        <th style="text-align: center;">Initial layout</th>
        <th style="text-align: center;">After calling: <pre>$tree->SetAttribute(INSERTBRANCH9, "new branch");</pre></th>
      </tr>
      <tr>
        <td><img src="http://kmx.github.com/perl-iup/spec/iuptree1.png"></td>
...
The caretE<rsquo>s position of the text
...
B<$ids:> Array of node identifiers. XXX-check-implementation
...
B<$userdata_ref:> #XXX-check-implementation.
...
L<IUP::ConvertXYToPos|IUP::ConvertXYToPos> to convert (x,y)
...
<p>
  <table border="1">
    <tbody align="center">
      <tr>
        <th style="text-align: center;">Initial layout</th>
        <th style="text-align: center;">After calling: <pre>$tree->TreeAddNodes( {TITLE=>"subtree", child=>["item1","item2"]}, 9);</pre></th>
      </tr>
      <tr>
        <td><img src="http://kmx.github.com/perl-iup/spec/iuptree1.png"></td>
...
<p>
  <table border="1">
    <tbody align="center">
      <tr>
        <th style="text-align: center;">Initial layout</th>
        <th style="text-align: center;">After calling: <pre>$tree->TreeInsertNodes( {TITLE=>"subtree", child=>["item1","item2"]}, 9);</pre></th>
      </tr>
      <tr>
        <td><img src="http://kmx.github.com/perl-iup/spec/iuptree1.png"></td>
