...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iupcolorbrowser.png"></td>
</p>
...
The initial size is "181x181". Set to NULL to allow the automatic layout
use smaller values.
...
The original doc: L<iupcolorbrowser.html|http://www.tecgraf.puc-rio.br/iup/en/elem/iupcolorbrowser.html>
