...
IUP::PPlot - [GUI element] xxx creating plots that
...
=head3 PlotBegin()
 ...
 void IUP::PlotBegin(Ihandle* ih, int strXdata); [in C] XXX-TODO
...
=head3 PlotAdd()
 ...
 void IUP::PlotAdd(Ihandle* ih, float x, float y); [in C] XXX-TODO
...
---- XXX-???
 ...
 void IUP::PlotAddStr(Ihandle* ih, const char* x, float y); [in C] XXX-TODO
...
=head3 PlotEnd()
 ...
 int IUP::PlotEnd(Ihandle* ih); [in C] XXX-TODO
...
=head3 PlotInsert()
 ...
 void IUP::PlotInsert(Ihandle *ih, int index, int sample_index, float x, float y); [in C] XXX-TODO
...
=head3 PlotInsertPoints()
 ...
 void IUP::PlotInsertPoints(Ihandle *ih, int index, int sample_index, float* x, float* y, int count); [in C] XXX-TODO
...
=head3 PlotAddPoints()
 ...
 void IUP::PlotAddPoints(Ihandle *ih, int index, float* x, float* y, int count); [in C] XXX-TODO
...
=head3 PlotTransform()
 ...
 void IUP::PlotTransform(Ihandle* ih, float x, float y, int *ix, int *iy); [in C] XXX-TODO
...
=head3 PlotPaintTo()
 ...
 void IUP::PlotPaintTo(Ihandle* ih, cdCanvas* cnv); [in C] XXX-TODO
...
once for each selected point.
 ...
 int function(Ihandle *ih, int index, int sample_index, float x, float y); [in C] XXX-TODO
...
also defined.
 ...
 int function(Ihandle *ih); [in C] XXX-TODO
...
changed.
 ...
 int function(Ihandle *ih, int index, int sample_index, float x, float y, int select); [in C] XXX-TODO
...
changed.
 ...
 int function(Ihandle *ih, int index, int sample_index, float x, float y, float *new_x, float *new_y); [in C] XXX-TODO
...
B<Returns:> If IUP_IGNORE then the sample is not edited. The application
...
function.
 ...
 int function(Ihandle *ih, cdCanvas* cnv); [in C] XXX-TODO
