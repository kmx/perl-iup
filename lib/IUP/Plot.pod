...
<p>
  <table border="1">
    <tbody>
    <tr>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot0.gif" border="0"></td>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot1.gif" border="0"></td>

    </tr>
    <tr>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot2.gif" border="0"></td>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot3.gif" border="0"></td>
    </tr>
    <tr>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot4.gif" border="0"></td>
      <td style="text-align: center;"><img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iup_pplot5.gif" border="0"></td>
    </tr>
  </table>
</p>
...
NOTE: there is an autodetection whether it calls iupPlotAddStr
or iupPlotAdd behind the scene.
...
Can only be called if L<PlotBegin|IUP::Plot/"PlotBegin()"> was called. Whenever you create a
...
only after the dataset is added to the plot (after L<PlotBegin|/"PlotBegin()">).

NOTE: there is an autodetection whether it calls iupPlotInsertStr
or iupPlotInsert behind the scene.

=head3 PlotInsertPoints()

 @values = ( $x1, $y1, $x2, $y2, $x3, $y3, $x4, $y4 );
 $plot->InsertPoints($index, $sample_index, \@values);

Inserts an array of samples in a dataset at the given B<sample_index>. (Since iup-3.4)
...
NOTE: there is an autodetection whether it calls iupPlotInsertStrPoints
or iupPlotInsertPoints behind the scene.
...
NOTE: there is an autodetection whether it calls iupPlotAddStrPoints
or iupPlotAddPoints behind the scene.
...
area. To position elements in plot units, use the L<PlotTransform|IUP::Plot/"PlotTransform()">
function.
