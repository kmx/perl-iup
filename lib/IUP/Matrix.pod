...
many systems have. It inherits from L<IUP::Canvas|IUP::Canvas> XXX-check-this.
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iupmatrix1.png">
</p>
<p>
<img src="http://kmx.github.com/perl-iup/img-3.5/ctrl/iupmatrix2.png">
</p>
...
C|iupmatrix_attrib.html#MASKL:C>
...
ex - IUP::MatSetAttribute(ih, "", 30, 10, value) == IUP::SetAttribute(ih, "30:10", value)
