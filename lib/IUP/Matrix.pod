...
=head2 CREATION - new() method
 ...
 Ihandle* IUP::Matrix(char *action_cb); [in C]
...
=item * L<CURSOR|iupmatrix_attrib.html#CURSOR>

=item * L<FITTOSIZE|iupmatrix_attrib.html#FITTOSIZE>

=item * L<FOCUS_CELL|iupmatrix_attrib.html#FOCUS_CELL>

=item * L<HIDEFOCUS|iupmatrix_attrib.html#HIDEFOCUS>

=item * L<READONLY|iupmatrix_attrib.html#READONLY>

=item * L<RESIZEMATRIX|iupmatrix_attrib.html#RESIZEMATRIX>

=item * L<USETITLESIZE|iupmatrix_attrib.html#USETITLESIZE>
...
=item * L<LC|iupmatrix_attrib.html#L:C>

=item * L<BGCOLOR|iupmatrix_attrib.html#BGCOLOR>

=item * L<FGCOLOR|iupmatrix_attrib.html#FGCOLOR>

=item * L<FONT|iupmatrix_attrib.html#FONT>

=item * L<FRAMECOLOR|iupmatrix_attrib.html#FRAMECOLOR>

=item * L<VALUE|iupmatrix_attrib.html#VALUE>
...
=item * L<ALIGNMENTn|iupmatrix_attrib.html#ALIGNMENTn>

=item * L<SORTSIGNn|iupmatrix_attrib.html#SORTSIGNn>
...
=item * L<RASTERWIDTHn|iupmatrix_attrib.html#RASTERWIDTHn>

=item * L<WIDTHn|iupmatrix_attrib.html#WIDTHn>

=item * L<WIDTHDEF|iupmatrix_attrib.html#WIDTHDEF>
...
=item * L<HEIGHTn|iupmatrix_attrib.html#HEIGHTn>

=item * L<HEIGHTDEF|iupmatrix_attrib.html#HEIGHTDEF>

=item * L<RASTERHEIGHTn|iupmatrix_attrib.html#RASTERHEIGHTn>
...
=item * L<ADDCOL|iupmatrix_attrib.html#ADDCOL>

=item * L<ADDLIN|iupmatrix_attrib.html#ADDLIN>

=item * L<DELCOL|iupmatrix_attrib.html#DELCOL>

=item * L<DELLIN|iupmatrix_attrib.html#DELLIN>

=item * L<NUMCOL|iupmatrix_attrib.html#NUMCOL>

=item * L<NUMCOL_VISIBLE|iupmatrix_attrib.html#NUMCOL_VISIBLE>

=item * L<NUMLIN|iupmatrix_attrib.html#NUMLIN>

=item * L<NUMLIN_VISIBLE|iupmatrix_attrib.html#NUMLIN_VISIBLE>
...
=item * L<MARKAREA|iupmatrix_attrib.html#MARKAREA>

=item * L<MARKMODE|iupmatrix_attrib.html#MARKMODE>

=item * L<MARK|iupmatrix_attrib.html#MARK>

=item * L<MARKED|iupmatrix_attrib.html#MARKED>

=item * L<MARKMULTIPLE|iupmatrix_attrib.html#MARKMULTIPLE>
...
=item * L<EDIT_MODE|iupmatrix_attrib.html#EDIT_MODE>

=item * L<ORIGIN|iupmatrix_attrib.html#ORIGIN>

=item * L<SHOW|iupmatrix_attrib.html#SHOW>

=item * L<REDRAW|iupmatrix_attrib.html#REDRAW>

=back

=head2 Text Edition Attributes

=over

=item * L<CARET|iupmatrix_attrib.html#CARET>

=item * L<MASKLC|iupmatrix_attrib.html#MASKL:C>

=item * L<MULTILINE|iupmatrix_attrib.html#MULTILINE>

=item * L<SELECTION|iupmatrix_attrib.html#SELECTION>
...
=item * L<BORDER|iupmatrix_attrib.html#BORDER>

=item * L<SCROLLBAR|iupmatrix_attrib.html#SCROLLBAR>
...
=item * L<ACTION_CB|iupmatrix_cb.html#ACTION_CB> - Action generated when a
keyboard event occurs.

=item * CLICK_CB - Action generated when any mouse button is pressed over a
cell.

=item * L<RELEASE_CB|iupmatrix_cb.html#RELEASE_CB> - Action generated when any
mouse button is released over a cell.

=item * L<MOUSEMOVE_CB|iupmatrix_cb.html#MOUSEMOVE_CB> - Action generated to
notify the application that the mouse has moved over the matrix.

=item * L<ENTERITEM_CB|iupmatrix_cb.html#ENTERITEM_CB> - Action generated when
a matrix cell is selected, becoming the current cell.

=item * LEAVEITEM_CB - Action generated when a cell is no longer the current
cell.

=item * L<SCROLLTOP_CB|iupmatrix_cb.html#SCROLL_CB> - Action generated when the
...
=item * L<BGCOLOR_CB|iupmatrix_cb.html#BGCOLOR_CB> - Action generated to
retrieve the background color of a cell when it needs to be redrawn.

=item * L<FGCOLOR_CB|iupmatrix_cb.html#FGCOLOR_CB> - Action generated to
retrieve the foreground color of a cell when it needs to be redrawn.

=item * L<FONT_CB|iupmatrix_cb.html#FONT_CB> - Action generated to retrieve the
font of a cell when it needs to be redrawn.

=item * L<DRAW_CB|iupmatrix_cb.html#DRAW_CB> - Action generated before the cell
is drawn. Allow a custom cell draw.

=item * L<DROPCHECK_CB|iupmatrix_cb.html#DROPCHECK_CB> - Action generated to
...
=item * L<DROP_CB|iupmatrix_cb.html#DROP_CB> - Action generated to determine if
a text field or a dropdown will be shown.

=item * L<DROPSELECT_CB|iupmatrix_cb.html#DROPSELECT_CB> - Action generated
when an element in the dropdown list is selected.

=item * EDITION_CB - Action generated when the current cell enters or leaves
the edition mode.
...
=item * L<VALUE_CB|iupmatrix_cb.html#VALUE_CB> - Action generated to verify the
value of a cell.

=item * L<VALUE_EDIT_CB|iupmatrix_cb.html#VALUE_EDIT_CB> - Action generated to
notify the application that the value of a cell was edited.

=item * L<MARK_CB|iupmatrix_cb.html#MARK_CB> - Action generated to verify the
selection state of a cell.

=item * MARKEDIT_CB - Action generated to notify the application that the
...
matrix
 ...
 void  IUP::MatSetAttribute(Ihandle* ih, const char* name, int lin, int col, const char* value);
 void  IUP::MatStoreAttribute(Ihandle* ih, const char* name, int lin, int col, const char* value);
 char* IUP::MatGetAttribute(Ihandle* ih, const char* name, int lin, int col);
 int   IUP::MatGetInt(Ihandle* ih, const char* name, int lin, int col);
 float IUP::MatGetFloat(Ihandle* ih, const char* name, int lin, int col);
 void  IUP::MatSetfAttribute(Ihandle* ih, const char* name, int lin, int col, const char* format, ...);
...
ex:
 ...
 IUP::MatSetAttribute(ih, "", 30, 10, value) == IUP::SetAttribute(ih, "30:10", value)
 IUP::MatSetAttribute(ih, "BGCOLOR", 30, 10, value) == IUP::SetAttribute(ih, "BGCOLOR30:10", value)
 IUP::SetAttributeId(ih, "ALIGNMENT", 10, value) == IUP::SetAttribute(ih, "ALIGNMENT10", value)
...
Some of these functions are also available in Lua:
 ...
 iup.MatSetAttribute(ih: ihandle, name: string, lin: number, col: number, value: string)
 iup.MatStoreAttribute(ih: ihandle, name: string, lin: number, col: number, value: string)
 iup.MatGetAttribute(ih: ihandle, name: string, lin: number, col: number) -> value: string
...
2 - No longer set the value of the cells. They will be set one by one
...
4 - When the matrix must be invalidated, use the REDRAW attribute to
...
A matrix might have titles for lines and columns. Titles are not
...
=item * B<F2, Enter> or B<Space>: enters editing mode.
