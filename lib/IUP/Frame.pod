=for comment based on iup-3.5 (attributes refreshed to iup-3.32) - http://www.tecgraf.puc-rio.br/iup/en/elem/iupframe.html
...
Allows to specify a position offset for the child. Available for native
