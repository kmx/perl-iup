...
=item * L<0-basic/cells_checkboard.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/cells_checkboard.pl> - IUP::Cells example

=item * L<0-basic/cells_degrade.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/cells_degrade.pl> - IUP::Cells example

=item * L<0-basic/cells_numbering.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/cells_numbering.pl> - IUP::Cells example
...
=item * L<0-basic/dial.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/dial.pl> - IUP::Dial example

=item * L<0-basic/dialog1.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/dialog1.pl> - IUP::Dialog example

=item * L<0-basic/dialog2.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/dialog2.pl> - IUP::Dialog example
...
=item * L<0-basic/expander.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/expander.pl> - IUP::Expander example
...
=item * L<0-basic/glcanvas1.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/glcanvas1.pl> - IUP::CanvasGL example

=item * L<0-basic/glcanvas2.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/glcanvas2.pl> - IUP::CanvasGL example
...
=item * L<0-basic/idle.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/idle.pl> - IUP->SetIdle Example
...
=item * L<0-basic/mask_matrix.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/mask_matrix.pl> - IUP::Matrix + MASK example
...
=item * L<0-basic/matrixlist.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/matrixlist.pl> - IUP::MatrixList example

=item * L<0-basic/matrix_basic.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/matrix_basic.pl> - IUP::Matrix example

=item * L<0-basic/matrix_cbmode.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/matrix_cbmode.pl> - IUP::Matrix (callback mode) example

=item * L<0-basic/menu.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/menu.pl> - IUP::Menu example

=item * L<0-basic/message_clone.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/message_clone.pl>

=item * L<0-basic/mglplot1.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/mglplot1.pl> - IUP::MglPlot example

=item * L<0-basic/plot1.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/plot1.pl> - IUP::PPlot example

=item * L<0-basic/plot2.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/plot2.pl> - IUP::PPlot example

=item * L<0-basic/plot3.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/plot3.pl> - IUP::PPlot example

=item * L<0-basic/plot4.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/plot4.pl> - IUP::PPlot example

=item * L<0-basic/plot5.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/plot5.pl> - IUP::PPlot example
...
=item * L<0-basic/progressbar1.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/progressbar1.pl> - IUP::Progressbar example
...
=item * L<0-basic/timer.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/timer.pl> - IUP::Timer example

=item * L<0-basic/toggle.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/toggle.pl> - IUP::Toggle example

=item * L<0-basic/tray.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/tray.pl> - IUP::Dialog + TRAY / TRAYTIP / TRAYIMAGE example
...
=item * L<0-basic/tree2.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/tree2.pl> - IUP::Tree example (figures) - using attribute only interface

=item * L<0-basic/tree3.pl|https://metacpan.org/source/KMX/IUP-0.201/examples/0-basic/tree3.pl> - IUP::Tree example (figures) - using attribute only interface
