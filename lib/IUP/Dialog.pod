...
=head2 CREATION - new() method
 ...
 Ihandle* IUP::Dialog(Ihandle *child); [in C]
...
L<TITLE|IUP::Manual::03_Attributes/TITLE> (non inheritable)
...
=head3 Exclusive [Windows and GTK Only]
...
=head3 Exclusive MDI [Windows Only]
...
=item * L<CLOSE_CB|../call/iup_close_cb.html>
...
screen. The coordinates are the same as the ???xxxTODO

=item * L<SCREENPOSITION|IUP::Manual::03_Attributes/SCREENPOSITION> attribute. (since
3.0)
...
=item * L<SHOW_CB|../call/iup_show_cb.html>
