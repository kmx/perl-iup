...
warn "xxx TODO xxx not defined CD_BOLD";
  #$cnv->cdCanvasFont(undef, CD_BOLD, 10);
...
sub dial1_btnup_cb {
  ...
  $x1 = $plot[$ii]->GetFloat("OLD_YMIN");
  $x2 = $plot[$ii]->GetFloat("OLD_YMAX");
  ...
  if ($x1<$x2) {
    $plot[$ii]->SetfAttribute("AXS_YMIN", "%f", $x1);
    $plot[$ii]->SetfAttribute("AXS_YMAX", "%f", $x2);
  }
...
sub dial2_btnup_cb {
  ...
  $x1 = $plot[$ii]->GetFloat("OLD_XMIN");
  $x2 = $plot[$ii]->GetFloat("OLD_XMAX");
  ...
  $plot[$ii]->SetfAttribute("AXS_XMIN", "%f", $x1);
  $plot[$ii]->SetfAttribute("AXS_XMAX", "%f", $x2);
