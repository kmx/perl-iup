...
=item * L<FORMATTING|[%m.at%]/FORMATTING> [Windows and GTK Only] (non inheritable)
...
mouse button is pressed or released. Use L<IUP::ConvertXYToPos|IUP::ConvertXYToPos> to convert (x,y)
