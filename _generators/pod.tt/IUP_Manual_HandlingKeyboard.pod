...
L<IUP::GetFocus|IUP::GetFocus> and L<IUP::SetFocus|IUP::SetFocus>. When the focus is changed the
...
functions L<IUP::NextField|IUP::NextField> and L<IUP::PreviousField|IUP::PreviousField>. To remove the Tab
 ...
 *		K_asterisk
 ...
 Context Menu	K_Menu
 ´		K_acute    xxxencoding broken
 ç		K_ccedilla xxxencoding broken
 F1		K_F1
 F2		K_F2
 F3		K_F3
 F4		K_F4
