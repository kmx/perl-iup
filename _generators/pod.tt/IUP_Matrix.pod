...
The L<MASK|[%m.at%]/MASK> auxiliary attributes are also
...
B<$key:> Identifier of the typed key. Please refer to the L<[%m.keys%]> and L<IUP::Constants> for a list of possible values.
...
L<SCROLL_CB|[%m.cb%]/SCROLL_CB>,
L<KEYPRESS_CB|[%m.cb%]/KEYPRESS_CB>,
L<MOTION_CB|[%m.cb%]/MOTION_CB>,
L<MAP_CB|[%m.cb%]/MAP_CB>

=item * L<RESIZE_CB|[%m.cb%]/RESIZE_CB> and L<BUTTON_CB|[%m.cb%]/BUTTON_CB> cannot be changed from perl IUP bindings.
