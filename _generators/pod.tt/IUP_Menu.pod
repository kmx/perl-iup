...
[% h.create %]
 ...
 Ihandle* IUP::Menu(Ihandle *child, ...); [in C]
 Ihandle* IUP::Menuv(Ihandle **children); [in C]
...
=item * L<OPEN_CB|../call/iup_open_cb.html>
...
=item * L<MENUCLOSE_CB|../call/iup_menuclose_cb.html>
