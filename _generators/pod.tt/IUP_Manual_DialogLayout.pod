...
so it can be associated with a native control. L<Show|[%m.elem%]/"Show()">, B<IUP::ShowXY> or L<Popup|[%m.elem%]/"Popup()"> will automatically call L<Map|[%m.elem%]/"Map()"> 
before showing a dialog. To remove this association call L<IUP::Unmap|IUP::Unmap>.
