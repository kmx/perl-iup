...
is done by means of L<attributes|[%m.at%]> and L<callbacks|[%m.cb%]>, using functions
...
=item * L<[%m.dlg%]> - composing more complex application layout

=item * L<[%m.elem%]> - common IUP element methods

=item * L<[%m.at%]> - common IUP element attributes

=item * L<[%m.cb%]> - common IUP element callbacks
