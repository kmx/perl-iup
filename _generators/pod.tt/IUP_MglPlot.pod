...
Each dataset is added using the L<IUP::MglPlotAdd*|IUP::MglPlotAdd*>, L<IUP::MglPlotInsert*|IUP::MglPlotInsert*>
andB< IUP::MglPlotSet* >functions. All other plot parameters are
...
Adds a sample to the dataset. Can only be called if L<IUP::MglPlotBegin|IUP::MglPlotBegin>
...
=head3 PlotSetFormula()
 ...
 $plot->PlotSetFormula($ds_index, $formulaX, $formulaY, $formulaZ, $count);
...
same as setting AXS_?ORIGIN to 0 or NULL. Can be
YES or NO. Default: NO. Returns YES if AXS_?ORIGIN is 0 and returns NO
if AXS_?ORIGIN in NULL. Available for compatibility with IUP::PPlot, but
