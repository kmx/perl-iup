...
Same as L<ACTIVE|[%m.at%]/ACTIVE> but does not affect the controls
...
To associate a name to element use L<SetName|[%m.elem%]/"SetName()"> or C<< name=>'ElemName' >> named parameter of L<new()|[%m.elem%]/"new()"> constructor.
