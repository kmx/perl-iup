...
Simply call L<IUP::Show|IUP::Show> or L<IUP::Hide|IUP::Hide> for the dialog.
...
when focus is in another control of the dialog. Use L<IUP::SetHandle> or
...
The previous menu, if any, is unmapped. Use L<IUP::SetHandle> or
L<IUP::SetAttributeHandle|IUP::SetAttributeHandle> to
...
L<IUP::Show|IUP::Show>/L<IUP::Popup|IUP::Popup> the attribute is set back to "NORMAL". FULL is
...
=for html <p><img src="[%url.ghwebroot%]/img-3.5/dlg/mdi.gif"></p> 
...
The original doc: L<iupdialog.html|[%url.iuporigdoc%]elem/iupdialog.html>
[%END%] 
