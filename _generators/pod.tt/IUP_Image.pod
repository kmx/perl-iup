...
You can use images/icons from the B<IupImageLib>, a library of pre-defined images - see L<[%m.imglib%]>:
...
The original doc: L<iupimage.html|[%url.iuporigdoc%]elem/iupimage.html>, L<iupimglib.html|http://www.tecgraf.puc-rio.br/iup/en/iupimglib.html>
[%END%] 
