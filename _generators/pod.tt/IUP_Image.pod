...
[% h.desc %], IUP::ImageRGB, IUP::ImageRGBA
...
Please observe the rules for creating cursor images: L<CURSOR|[%m.at%]/CURSOR>.

=head2 Usage

Images are used in elements such as buttons and labels by attributes
that points to names registered with L<IUP::SetHandle>. You can also use
...
The original doc: L<iupimage.html|[%url.iuporigdoc%]elem/iupimage.html>
[%END%] 
