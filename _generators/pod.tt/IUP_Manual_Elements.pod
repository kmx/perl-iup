...
B<$dialog:> Reference to IUP::Dialog object.
...
return value will be different. You could call C<Flush()> between the
...
See the L<PLACEMENT|[%m.at%]/PLACEMENT> attribute for other position and show options.
