...
each parameter is the equivalent C type (boolean is integer).
...
B<param_index>: current parameter being changed. It is -1 if the user
pressed the B<OK> button. It is -2 after the dialog is B<mapped> and
just before it is shown. It is -3 if the user pressed the B<Cancel>
button. It is -4 if the user pressed the B<Help> button, if any.
...
IupFileDlg|iupfiledlg.html> control when activated. All commas must
...
number of required parameters. But separators will not count as
parameters.
...
you want.
  ...
  float preal4 = 0.5f;
  float pangle5 = 90;
  char pstring6[100] = "string text";
  int plist7 = 2;
  char pfile_name8[500] = "test.jpg";
  char pcolor9[100] = "255 0 128";
  char pstring10[200] = "second text\nsecond line";
  ...
  if (!IupGetParam("Title", param_action, 0,
                   ...
                   &pboolean0, &pinteger1, &preal2, &pinteger3, &preal4, &pangle5, pstring6, &plist7, pfile_name8, pcolor9, pstring10, NULL))
    return IUP_DEFAULT;
