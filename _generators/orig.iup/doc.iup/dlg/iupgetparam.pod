...
-1 = if the user pressed the B<OK> button;

-2 = after the dialog is B<mapped> and just before it is shown;

-3 = if the user pressed the B<Cancel> button;

-4 = if the user pressed the B<Help> button, if any;
