...
Creates a resizeable container. Allows the provided control to be
enclosed in a box that allows expanding and contracting the element
B<size> in one direction.
