...
B<Working now> on IupPPlot, studding possible use of
L<PLplot|http://plplot.sourceforge.net/> as a replacement.

=over

=item * IupTree, IupList and IupMatrix improvements
...
=item * B<Priority:> Drag&Drop between controls.
...
applications controled elements.
