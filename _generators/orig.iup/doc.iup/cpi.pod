...
The function iupXxxGetClass is internal to the control and it creates
the control class.
...
You can use the iupXxxGetClass equivalent function of other controls to
...
methods and attribute functions to simplify your iupXxxGetClass.

If the control is a native control then it usually will have separate
modules for each driver. The iupXxxGetClass function could call a
...
common pratice to have a convenience function to create the control:
