...
This is an additional control that depends on the L<Controls
...
B<IupList> control it is not read-only.
...
B<EDITABLE>: enables the interactive editing of the list. It can be Yes
