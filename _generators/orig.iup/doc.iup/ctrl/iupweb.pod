=head1 IupWebBrowser [GTK and Windows only]
...
frames, or when a page loads also other pages. (since 3.3.1)
...
B<ERROR_CB>: action generated when page load fail. (since 3.3.1)
