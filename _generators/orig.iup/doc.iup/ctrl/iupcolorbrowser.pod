...
B<RGB> (non inheritable): the color selected in the control, in the
E<ldquo>r g bE<rdquo> format; r, g and b are integers ranging from 0 to
255. Default: "255 0 0".

B<HSI> (non inheritable): the color selected in the control, in the
E<ldquo>h s iE<rdquo> format; h, s and i are floating point numbers
ranging from 0-360, 0-1 and 0-1 respectively.
...
also changes, visually compacting values above or bellow the I=0.5 line
