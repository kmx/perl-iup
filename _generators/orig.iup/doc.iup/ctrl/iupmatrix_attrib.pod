...
B<EDITNEXT>: controls how the next cell after editing is chosen. Can be
LIN, COL, LINCR, COLCR. Default: LIN. (since 3.4)
...
X<FITTOTEXT>B<FITTOTEXT> (write-only): set the RASTERWIDTHn or the
