...
Return: an integer that specifies the desired height (in pixels).
...
Return: an integer that specifies the desired span. Default is 1 (no
span).
...
Return: an integer that specifies the number of columns. Default is 10
columns.
...
Return: an integer that specifies the number of lines. Default is 10
lines.
...
Return: If IUP_IGNORE the cell is not redrawn. By default the cell is
always redrawn.
...
Return: an integer that specifies the desired width (in pixels).
