...
=item * In the Tools list, click on ILINK32. Then bellow select the
Path and Defines tab - there you are going to add the path of the
libraries you use, for example:
...
=item * In the Tools list, click on IBCC32. Then bellow select the Path
