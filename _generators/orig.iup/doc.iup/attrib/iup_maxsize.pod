=head1 MAXSIZE (non inheritable) (since 3.0)
...
The B<IupDialog> has the same attribute but within a different behavior
...
L<RASTERSIZE|iup_rastersize.html>, L< MINSIZE|iup_minsize.html>
