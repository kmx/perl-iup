...
corner of the screen. Accept values in the format "XB<x>Y", example
"200x200". Can be set only in GTK 2.8.
...
=head2 B<X<VIRTUALSCREEN>VIRTUALSCREEN> (read-only) (since 3.0) [Win32
and GTK Only]
...
=head2 X<MONITORSINFO>MONITORSINFO (read-only) (since 3.0) [Win32 and
GTK Only]
