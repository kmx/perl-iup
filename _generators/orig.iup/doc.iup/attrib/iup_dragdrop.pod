...
B<DRAGC>B<URSOR (non inheritable):> name of an image to be used as
cursor during drag. Use L<IupSetHandle|../func/iupsethandle.html> or
L<IupSetAttributeHandle|../func/iupsetattributehandle.html> to
associate an image to a name. See also
L<IupImage|../elem/iupimage.html>. (since 3.11)
