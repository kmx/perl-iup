...
B<It is recomended to use EMF instead of WMF whenever is possible.>
...
B< Behavior of Functions> of the L<Microsoft Windows
(GDI)|drv/win32.html> platform. However, it should be noted that some
