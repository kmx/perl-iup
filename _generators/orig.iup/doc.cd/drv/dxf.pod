...
version 10.0 or later. The format's copyrights are property of
L<Autodesk|http://www.autodesk.com>.
...
=item * L<B<Sector>|../func/filled.html#cdSector>: draws a "hollow"
sector, that is, only its borders.
...
=item * filled primitives are NOT supported.
