...
Red Hat 7.3 (x86) / Kernel 2.4 / gcc 2.95 / L<Open Motif
2.1|http://www.ist-inc.com/DOWNLOADS/motif_download.html> / GTK 2.0

B<Linux24g3>

CentOS 3.9 (x86) / Kernel 2.4 / gcc 3.2 / Open Motif 2.2 3 / GTK 2.2

B<Linux24g3_64>

Red Hat E.L. WS 3 (x64) / Kernel 2.4 / gcc 3.2 / Open Motif 2.2 3 / GTK
2.2

B<Linux26>

CentOS 4.6 (x86) / Kernel 2.6 / gcc 3.4 / Open Motif 2.2 3 / GTK 2.4

B<Linux26_64>

CentOS 4.6 (x64) / Kernel 2.6 / gcc 3.4 / Open Motif 2.2 3 / GTK 2.4

B<Linux26g4>

CentOS 5.3 (x86) / Kernel 2.6 / gcc 4.1 / Open Motif 2.2 3 / GTK 2.12

B<Linux26g4_64>

CentOS 5.2 (x64) / Kernel 2.6 / gcc 4.1 / OpenMotif 2.2 3 / GTK 2.10

B<Linux26g4ppc>

Ubuntu 7.10 (ppc) / Kernel 2.6 / gcc 4.1 / Open Motif 2.2 3 / GTK 2.?

B<Linux26_ia64>

Red Hat E.L. AS 4 (ia64) / Kernel 2.6 / gcc 3.4 / Open Motif 2.2 3 /
GTK 2.4

B<SunOS57>

Sun Solaris 7 (sparc) / gcc 2.95 / Motif 2.1
...
Sun Solaris 10 (x86) / gcc 3.3 / Motif 2.1
...
Static library built with Microsoft Visual C++ 6 (static RTL/single
thread)

B<Win32_vc7>

Static library built with Microsoft Visual C++ 7.1 (.NET 2003) (static
RTL/single thread)
...
DLL and import library built with vc6, creates dependency with
MSVCRT.DLL

B<Win32_dll7>

DLL and import library built with vc7, creates dependency with
MSVCR71.DLL
...
Static library built with Cygwin gcc 3.4 (Depends on Cygwin DLL 1.5)
...
Same as B<Win32_gcc3>, but using the Cygwin Posix system and also with
...
Static library built with MingW gcc 3.4

B<Win32_mingw4>

Static library built with MingW gcc 4.3 -
...
DLL and import library built with MingW gcc 4.3 (See B<Win32_mingw4>)
...
Static library built with Borland C++ BuilderX 1.0 / Borland C++ 5.6
Compiler E<sup1>,E<sup2>

(the C++ BuilderX IDE can also be configured to use mingw3 or gcc3
versions.)
