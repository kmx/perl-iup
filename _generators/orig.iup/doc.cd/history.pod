...
=item * Fixed: canvas:Transform when nil is used to reset the
transformation.
...
=item * New: attribute "WINDOWRGN" for the Native Windows and IUP
drivers to set the shape of a window to the current complex clipping
region.
