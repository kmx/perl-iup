...
#    at_mot     => '=head3 Motif Subsystem',
  ...
  n => {
    ...
    iupanimatedlabel           =>           'IUP::AnimatedLabel - [GUI element] animated label',
    iupbackgroundbox           =>           'IUP::BackgroundBox - [GUI element] background box',
    iupbutton                  =>                  'IUP::Button - [GUI element] button decorated with a text and/or an image',
    iupcalendar                =>                'IUP::Calendar - [GUI element] calendar',
    ...
    iupdatepick                =>                'IUP::DatePick - [GUI element] date picker',
    iupdetachbox               =>               'IUP::DetachBox - [GUI element] detachbox',
    ...
    iupglexpander              =>            'IUP::GL::Expander - [GUI element] GL-based expander',
    iupglframe                 =>               'IUP::GL::Frame - [GUI element] GL-based frame',
    iupgllabel                 =>               'IUP::GL::Label - [GUI element] GL-based label',
    iupgllink                  =>                'IUP::GL::Link - [GUI element] GL-based link',
    iupglprogressbar           =>         'IUP::GL::ProgressBar - [GUI element] GL-based progressbar',
    iupglscrollbox             =>           'IUP::GL::ScrollBox - [GUI element] GL-based scroll box',
    iupglseparator             =>           'IUP::GL::Separator - [GUI element] GL-based separator',
    iupglsizebox               =>             'IUP::GL::SizeBox - [GUI element] GL-based sizebox',
    iupglsubcanvas             =>           'IUP::GL::SubCanvas - [GUI element] GL-based subcanvas',
    iupgltext                  =>                'IUP::GL::Text - [GUI element] GL-based text lable',
    iupgltoggle                =>              'IUP::GL::Toggle - [GUI element] GL-based two-state (on/off) button',
    iupglval                   =>                 'IUP::GL::Val - [GUI element] GL-based value selector',
    ...
    iupplot                    =>                    'IUP::Plot - [GUI element] canvas-like element for creating 2D plots',
    ...
    iupscintilla               =>               'IUP::Scintilla - [GUI element] multiline source code text editor (based on Scintilla library)',
