...
B<See Also:> L<IUP::MapFont|IUP::MapFont>, L<IUP::UnMapFont|IUP::UnMapFont>. xxxTODOXX(maybe remove)
...
B<Value:> "(width)x(height)", where (width) and (height) are integer
...
B<Value:> "I<dx>xI<dy>", where I<dx> and I<dy> are integer values corresponding
...
B<Value:> "(width)x(height)", where (width) and (height) are integer values
...
B<Value:> "YES", "IGNORE" (since 3.3) or "NO".

B<Default:> "NO"

B<Affects:> All elements, except menus.

B<See Also:> L<IUP::Zbox|IUP::Zbox>, L<IUP::VBox|IUP::VBox>,
L<IUP::HBox|IUP::HBox>
...
B<Value:> "E<lt>xE<gt>,E<lt>yE<gt>", where E<lt>xE<gt> and E<lt>yE<gt>
...
B<See Also:> L<IUP::GetDialogChild|IUP::GetDialogChild>
...
redraw call L<IUP::Update|IUP::Update> in L<SCROLL_CB|IUP::Manual::04_CallbacksSCROLL_CB>.
