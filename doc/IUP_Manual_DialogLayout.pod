...
IUP::Manual::06_DialogLayout - Dialor Layout Composition
...
=item * IUP::Manual::06_DialogLayout E<nbsp>E<nbsp>E<nbsp>E<nbsp>E<nbsp> B<E<lt>E<lt>E<lt> this document>

=back

=head1 INTRODUCTION

xxxTODO text text text text text text text text text text text text
text text text text text text text text text text text text text text

xxxhave a look at: http://www.tecgraf.puc-rio.br/iup/download/spe95.pdf

xxx IUP::Dialog the main container

xxx talking about "custom dialogs"
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/dlg_led.png"></td>
</p>

=end html

=head2 xxx hbox, vbox & co.
...
<p>
  <table border="1">
    <tbody align="center">
      <tr>
        <th style="text-align: center;">IUP::Dialog</th>
        <th style="text-align: center;">IUP::Frame</th>
	<th style="text-align: center;">IUP::Canvas</th>
      </tr>
      <tr>
        <td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.3/images/nativesize1.gif"></td>
        <td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.3/images/nativesize2.gif"></td>
	<td style="vertical-align:top;"><img src="http://kmx.github.com/perl-iup/img-3.3/images/nativesize3.gif"></td>
      </tr>
    </tbody>
  </table>
</p>
...
native system and every time L<IUP::Map|IUP::Map> is called, even if the element
is already mapped.
...
buttons do not move or change their sizes.
 ...
 dlg = iup.dialog
 {
   ...
   ;title="IUP::Dialog", font="Helvetica, Bold 14" 
 }
 dlg:show()
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/naturalsize.gif"></td>
</p>
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/usersize.gif"></td>
</p>
...
L<IUP::Refresh|IUP::Refresh> is called.
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/expand.gif"></td>
</p>
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/no_shrink.gif"></td>
</p>
...
set the dialog initial size.
 ...
 dlg = iup.dialog
 {
   ...
   ;title="IUP::Dialog", shrink="yes", font="Helvetica, Bold 14" 
 }
 dlg:show()
...
<p>
<img src="http://kmx.github.com/perl-iup/img-3.3/images/shrink.gif"></td>
</p>
...
L<IUP::Create|IUP::Create> to create branches or nodes. To
destroy a node or branch call L<IUP::Destroy|IUP::Destroy>.

Some of the constructors already append children to its branch, but you
can add other children using L<IUP::Append|IUP::Append> or
L<IUP::Insert|IUP::Insert>. To remove from the tree call
L<IUP::Detach|IUP::Detach>.

For the element to be visible L<IUP::Map|IUP::Map> must be called
so it can be associated with a native control. L<IUP::Show|IUP::Show>, B<
IUP::ShowXY> or L<IUP::Popup|IUP::Popup> will automatically call L<IUP::Map|IUP::Map> before
showing a dialog. To remove this association call L<
IUP::Unmap|func/iupumap.html>.
...
when the constructor receives the children as a parameter L<IUP::Append|IUP::Append>
...
implicity there will be a call to:
 ...
 IUP::Create  -> IUP::Append -> IUP::Map
 IUP::Destroy <- IUP::Detach <- IUP::Unmap

A more simple and fast way to move an element from one position in the
hierarchy to another is using L<IUP::Reparent|IUP::Reparent>.

The dialog is the root of the hierarchy tree. To retrieve the dialog of
any element you can simply call L<IUP::GetDialog|IUP::GetDialog>,
but there are other ways to navigate in the hierarchy tree.

To get all the children of a container call L<
IUP::GetChild|func/iupgetchild.html> or
L<IUP::GetNextChild|IUP::GetNextChild>. To get just the next
control with the same parent use
L<IUP::GetBrother|IUP::GetBrother>. To get the parent of a
control call L<IUP::GetParent|IUP::GetParent>.
...
The layout size and positioning is automatically updated by L<IUP::Map|IUP::Map>.
L<IUP::Map|IUP::Map> also updates the dialog layout even if it is already mapped,
so using it or using L<IUP::Show|IUP::Show>, L<IUP::ShowXY|IUP::ShowXY> or L<IUP::Popup|IUP::Popup> (they all
call L<IUP::Map|IUP::Map>) will also update the dialog layout. The layout size and
positioning can be manually updated using
L<IUP::Refresh|IUP::Refresh>, even if the dialog is not mapped.
...
L<IUP::Refresh|IUP::Refresh> for an element inside the dialog to update the dialog
layout. To force a redraw of an element without layout update call
L<IUP::Update|IUP::Update>.
