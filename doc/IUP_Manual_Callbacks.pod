...
For more information about using callbacks see L<Callbacks Concept|IUP::Manual::01_BasicConcept/"Callbacks Concept">
...
To set this action use the function C<< IUP->SetIdle(\&myfunction) >>. xxxcheckthis
...
L<IUP-E<gt>Idle|IUP/Idle> xxxcheckthis
...
B<$press:> 1 is the user pressed the key or 0 otherwise. xxxotherwise means what?
...
considering the decorations (client size) xxxlink to "client size" description in layout.pod
